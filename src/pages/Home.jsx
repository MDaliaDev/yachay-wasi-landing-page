...
const collageData = [
  { image: '/images/header/1.png', text: 'Transformando vidas a través de la educación' },
  { image: '/images/header/2.png', text: 'Construyendo un futuro mejor' },
  { image: '/images/header/3.png', text: 'Aprendizaje colaborativo' },
  { image: '/images/header/4.png', text: 'Desarrollo integral' },
  { image: '/images/header/5.png', text: 'Educación de calidad' },
  { image: '/images/header/6.png', text: 'Formación continua' },
  { image: '/images/header/7.png', text: 'Impacto social' },
  { image: '/images/header/8.png', text: 'Comunidad educativa' },
  { image: '/images/header/9.png', text: 'Innovación educativa' },
  { image: '/images/header/10.png', text: 'Compromiso social' },
  { image: '/images/header/11.png', text: 'Educación rural' },
  { image: '/images/header/12.png', text: 'Apoyo estudiantil' },
  { image: '/images/header/13.png', text: 'Desarrollo comunitario' },
  { image: '/images/header/14.png', text: 'Voluntariado educativo' },
  { image: '/images/header/15.png', text: 'Inclusión educativa' },
  { image: '/images/header/16.png', text: 'Educación para todos' },
  { image: '/images/header/17.png', text: 'Aprendizaje significativo' },
  { image: '/images/header/18.png', text: 'Desarrollo sostenible' },
  { image: '/images/header/19.png', text: 'Educación intercultural' },
  { image: '/images/header/20.png', text: 'Tecnología educativa' },
  { image: '/images/header/21.png', text: 'Mentoría estudiantil' },
  { image: '/images/header/22.png', text: 'Desarrollo personal' },
  { image: '/images/header/23.png', text: 'Educación transformadora' },
  { image: '/images/header/24.png', text: 'Comunidades de aprendizaje' }
]
    ...
    <div className="page home">
      <header className="header-collage">
        ...
        <div className="logo-container">
          <img src="/images/logo_color.png" alt="Yachay Wasi Logo" />
        </div>
      ...
      <section className="stats-section" ref={statsRef}>
        <div className="wave-top">
          <img src="/animations/wave-top.svg" alt="" />
          
        </div>
        <div className="stats-background">
          <img src="/images/home/fondo-niños.png" alt="Fondo Niños" className="stats-bg-image" />
        ...
        <div className="wave-bottom">
          <img src="/animations/wave-bottom.svg" alt="" />
        </div>
      </section>
        ...
        <div className="achievements-grid">
          <div className="achievement-card">
            <div className="achievement-image">
              <img src="/images/home/upc.png" alt="Protagonistas del Cambio UPC 2024" />
            </div>
          ...
          <div className="achievement-card">
            <div className="achievement-image">
              <img src="/images/home/bicentenario.jpg" alt="Bicentenario Haciendo Patria 2021" />
            </div>
            <div className="achievement-content">
          ...
          <div className="achievement-card">
            <div className="achievement-image">
              <img src="/images/home/universidad.png" alt="Colaboración Universitaria" />
            </div>
            <div className="achievement-content">
          ...
          <div className="achievement-card">
            <div className="achievement-image">
              <img src="/images/home/backus.png" alt="Fondo Concursable Backus" />
            </div>
            <div className="achievement-content">
        ...
        <div className="carousel-container">
          <div className="carousel-track">
            ...
            <div className="carousel-item">
              <img src="/images/home/ally-1.jfif" alt="Aliado 1" />
            </div>
            <div className="carousel-item">
              <img src="/images/home/ally-2.jfif" alt="Aliado 2" />
            </div>
            <div className="carousel-item">
              <img src="/images/home/ally-3.jfif" alt="Aliado 3" />
            </div>
            <div className="carousel-item">
              <img src="/images/home/ally-4.jfif" alt="Aliado 4" />
            </div>
            <div className="carousel-item">
              <img src="/images/home/ally-5.jfif" alt="Aliado 5" />
            </div>
            <div className="carousel-item">
              <img src="/images/home/ally-6.jfif" alt="Aliado 6" />
            </div>
